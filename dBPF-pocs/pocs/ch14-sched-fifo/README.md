...
- Docker Desktop linuxkit 6.12 aarch64: works as shown. On stock
  cloud kernels with hardened lockdown / SELinux,
  `bpf_override_return` may be denied even with CAP_SYS_ADMIN.

## Blog post

See the chapter write-up: [`2025-03-15-sched-fifo-impersonator`](../../../_posts/2025-03-15-sched-fifo-impersonator.md) in the Diabolical eBPF Field Manual.
